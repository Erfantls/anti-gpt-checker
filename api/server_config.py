...
if API_MONGODB_AUTH_USER and API_MONGODB_AUTH_PASS and API_MONGODB_AUTH_DB:
    API_MONGO_CLIENT = AsyncIOMotorClient(host=API_MONGODB_URI, port=API_MONGODB_PORT, username=API_MONGODB_AUTH_USER, password=API_MONGODB_AUTH_PASS, authSource=API_MONGODB_AUTH_DB)
else:
    API_MONGO_CLIENT = AsyncIOMotorClient(API_MONGODB_URI, API_MONGODB_PORT)
